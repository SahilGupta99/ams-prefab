...
class Config:
    ...
    # SQLALCHEMY_DATABASE_URI = "mysql+mysqlconnector://avnadmin:AVNS_pZzZA0U361XyCoY4kIG@product-management-product-management.l.aivencloud.com:18798/defaultdb?ssl_mode=REQUIRED"
...
"Product-Management-final\ca.pem"